...
@section('content')
    ...
    <table id="dtj" style="height:450px" pagination="true" data-options="singleSelect:true,border:true,fit:true,fitColumns:true,scrollbarSize:5">
        <thead>
            <tr>
...
/*            onLoad: function(index,row){
            ...
            onSelect: function(index,row){
                $('#dtj').datagrid('getRowDetail',index).panel({
                    height:80,
                    border:false,
                    cache:false,
                    method:'get',
                    href:'/admin/penjualan/djual/'+row.id,
                    onLoad:function(){
